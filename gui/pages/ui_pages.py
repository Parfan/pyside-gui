...
################################################################################
## Form generated from reading UI file 'pagesTPPDTU.ui'
##
...
class Ui_application_pages(object):
    def setupUi(self, application_pages):
        ...
        application_pages.resize(1200, 720)
        self.page_1 = QWidget()
    ...
    def retranslateUi(self, application_pages):
        ...
        self.label_1.setText(QCoreApplication.translate("application_pages", u"P\u00e1gina inicial", None))
